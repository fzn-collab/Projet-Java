...
const CURRENT_USER_ID = 'entrepreneur1';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          const otherUser = item.participants.find(p => p !== CURRENT_USER_ID);
          const colors = ['#1A73E8', '#E91E63', '#4CAF50', '#FF9800', '#9C27B0'];
...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', color: '#333', marginBottom: 10 },
