...
const styles = StyleSheet.create({
  ...
  statCard: { backgroundColor: '#fff', borderRadius: 10, padding: 20, flex: 0.48, alignItems: 'center', elevation: 3 },
  statNumber: { fontSize: 32, fontWeight: 'bold', color: '#4CAF50' },
  statLabel: { fontSize: 12, color: '#666', marginTop: 4 },
  button: { backgroundColor: '#2196F3', padding: 15, borderRadius: 10, marginBottom: 10, alignItems: 'center' },
  buttonGreen: { backgroundColor: '#4CAF50' },
  buttonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginTop: 20, marginBottom: 10 },
  empty: { color: '#999', textAlign: 'center', marginTop: 20 },
  projectCard: { backgroundColor: '#fff', borderRadius: 10, padding: 15, marginBottom: 10, elevation: 2 },
